data.spec <- list(
  file.name = "Divided/data/ess/Round 3/ESS3e03_7.dta",
  file.type = 'dta',
  question.text = c(
  ...
  skip.countries = list(
    no_group = c("Cyprus", "Denmark", "Poland", "Portugal", "Slovenia", "Sweden", "United Kingdom")
  ),
...
cat.defs <- list(
  Party = list(
    "Missing" = c("Not applicable", "Refusal", "Don't know","No answer", "Blanc",
