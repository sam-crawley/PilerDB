data.spec <- list(
  file.name = "Divided/data/pew/2016/Pew Research Center Spring 2016 Global Attitudes Dataset WEB FINAL.sav",
  file.type = 'sav',
  question.text = c(
  ...
  pre_fixups = function(data) {
    ...
    data <- coalese.vars(data, c("q126us", str_subset(names(data), regex("^Q131", ignore_case = T))), "prty")
