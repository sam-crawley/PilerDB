data.spec <- list(
  file.name = "Divided/data/asain barom/W2 Merged Data/2w-3rd_release_all/merge/Wave2_20170724.sav",
  file.type = 'sav',
  skip.countries = c("Cambodia", "China", "Hong Kong SAR China", "Singapore", "Vietnam"),
