...
cat.defs <- list(
  Party = list(
    "Missing" = c("Do not feel close to any party", "No sabe (Dont know)", "No responde (Refused)", "Don’t know", "Refused", "Nao sabe (Don’t know)", 
                  "Outro (Other)", "Recusa (Refused)", "Dont know", "Menolak (Refused)", "No contestó (Refused)", "No sabe (Don’t know)", "Refused (DO NOT READ)",
                  "Don’t Know (DO NOT READ)", "(VOL) Don't know", "(VOL) Refused", "Tidak tahu (Don’t know)"),
  ...
  Religion = list(
    "Missing" = c("Refused (DO NOT READ)", "Don’t know (DO NOT READ)", "Dont know (DO NOT READ)", "(VOL) Refused", "Something else (SPECIFY), or", "(VOL)\xc2\xa0Don't know"),
