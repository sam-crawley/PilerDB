data.spec <- list(
  file.name = "Pew Research Center Global Attitudes Summer 2020 Dataset - Public.sav",
  file.type = 'sav',
  question.text = c(
...
cat.defs <- list(
  ...
  Religion = list(
    "Missing" = c("Refused", "Don’t know", "Dont know", "(VOL) Refused", "Something else (SPECIFY), or", "(VOL)\u00a0Don\'t know", "Don\u2019t know"),
