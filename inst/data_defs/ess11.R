...
cat.defs <- list(
  ...
  Religion = list(
    ...
    "Other" = c("Not applicable", "Other Christian denomination", "Other Non-Christian religions", 
                ...
                "Other Protestant", "Other non-Christian", "Other Eastern Orthodox", "Other Christian", 
                "Other Christian Denominations", "Other Eastern Orthodox, denomination not specified",
                "Other Non-Christian Religions", "Other Catholic (Roman)", "Other Christian religions",
                "Other Christian denominations", "Other Eastern religion, religion not specified",
                "Other Roman Catholic", "Other Orthodox", "Other Protestant denomination",
                "Other protestant", "Other Protestants, denomination not specified",
                "Other Catholic", "Other Pretestant")
  )
)
