data.spec <- list(
  file.name = "datasets/ess/Round 7/ESS7e02_2.dta",
  file.type = 'dta',
  question.text = c(
...
cat.defs <- list(
  Party = list(
    ...
    "Other" = c("Other (nir)", "Other party", "Other", "Independent", "Independent(s) (nir)",
                "Andet - other", "Autre", "Outro", "Annat parti", "\u00dcksikkandidaadid v\u00f5i muud", "Andere Partei",
                "Otro")
  ),
  Language = list(
